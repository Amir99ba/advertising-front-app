...
const testimonialsData: Testimonial[] = [
  {
    ...
    initials: "س م",
    text: "همکاری با آرکا مسیر برند ما را کاملاً تغییر داد؛ کمپین‌ها دقیق و نتیجه‌محور اجرا شدند.",
  },
  {
    name: "رضا کاظمی",
  ...
  },
  {
    ...
    initials: "ن ر",
    text: "کیفیت محتوا و نظم اجرایی آرکا فراتر از انتظار ما بود و همکاری را ادامه می‌دهیم.",
  },
];
